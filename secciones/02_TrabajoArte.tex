...
A continuación, se muestra una imagen actual del proceso de comunicación con la TGSS a través del Sistema RED:
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/02_SistemaRED.png}
    \caption{Esquema del proceso de comunicación con la TGSS mediante el Sistema RED.}
    \label{fig:sistema_red}
\end{figure}
