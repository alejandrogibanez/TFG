...
Una vez que el superusuario ha asignado manualmente el acceso a las empresas correspondientes, se consideran dis escenarios posibles para los usuarios de RRHH, dependiendo de si tienen o no el campo `Is\_supervisor` con valor cierto o falso:
\begin{itemize}
