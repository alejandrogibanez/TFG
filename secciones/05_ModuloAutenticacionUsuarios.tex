...
El diseño de la interfaz de acceso se ha concebido bajo un enfoque de minimalismo funcional y estética corporativa. Se ha optado por una distribución asimétrica en dos bloques diferenciados: el panel izquierdo concentra exclusivamente la carga interactiva, mientras que el panel derecho actúa como un elemento visual de soporte que refuerza la identidad profesional de la plataforma. Con esta estructura se consigue maximizar el espacio en blanco y reducir el ruido visual, guiando de forma directa la atención del usuario hacia los campos de entrada de datos. Este diseño prioriza una experiencia de usuario ágil y directa, evitando elementos distractores en una sección tan crítica como el control de acceso. Como bien se ha mencionado en el apartado 4.1, no se hacen validaciones de formato en tiempo real porque dichas validaciones se harán a través del formulario de creación de usuarios.
