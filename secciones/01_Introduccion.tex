...
\begin{itemize}
    ...
    \item \textbf{Capítulo 4. Módulo de gestión de usuarios:} Detalla el núcleo del sistema enfocado en la administración, jerarquía y delegación de permisos de usuarios, así como la estructura frontend y backend asociada a la autenticación segura.   
