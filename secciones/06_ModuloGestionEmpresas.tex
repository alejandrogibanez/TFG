...
A continuación, se adjunta una captura de pantalla del formulario de alta de empresa, que ilustra la interfaz y los campos requeridos para completar el proceso de registro:
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/06_CrearEmpresa.png}
    \caption{Formulario de Alta de Empresa}
    \label{fig:formulario_empresa}
\end{figure}

%6.1.2
\subsection{Edición y Gestión de Empresas Existentes}

Además de la creación, los usuarios con permisos de “admin” también pueden acceder a la gestión de las empresas ya registradas. Esto incluye la capacidad de editar los datos maestros de la empresa, actualizar información relevante y gestionar aspectos relacionados con la operativa diaria. La edición se realiza a través de una interfaz similar al formulario de alta, pero con los campos pre-cumplimentados con los datos existentes, permitiendo así una actualización eficiente y sin errores.

Adjuntamos a continuación una captura de pantalla de la interfaz de edición de empresa, que muestra cómo se presentan los datos para su modificación:
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/06_EditarEmpresa.png}
    \caption{Interfaz de Edición de Empresa}
    \label{fig:editar_empresa}
\end{figure}
